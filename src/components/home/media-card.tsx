...
export function MediaCard ({ name, url }: Props) {
  return <a href={url} className='border border-white flex justify-center transition-all relative overflow-hidden group hover:after:left-0 hover:border-gold
